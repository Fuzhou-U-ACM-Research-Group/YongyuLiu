...
$$
\alpha_i^j = \begin{marchingDegree}\frac{x_{i(k+1)} - x_i^*}{x_{i(k+1)} - x_{ik}},j=k,& \text{if }x_{ik} \leq x_i^* \leq x_{i(k+1)} \\ 1 - \frac{x_{i(k+1)} - x_i^*}{x_{i(k+1)} - x_{ik}},j=k+1 \\ 0, j=1,2,\ldots,|x_i|,j/not=k,k+1 \end{marchingDegree}$$
$$f(n) = \begin{cases} \frac{x_{i(k+1)} - x_i^*}{x_{i(k+1)} - x_{ik}},j=k,& \text{if }x_{ik} \leq x_i^* \leq x_{i(k+1)} \\ 1 - \frac{x_{i(k+1)} - x_i^*}{x_{i(k+1)} - x_{ik}}, & \text{if } n\text{ is odd} \end{cases}$$
