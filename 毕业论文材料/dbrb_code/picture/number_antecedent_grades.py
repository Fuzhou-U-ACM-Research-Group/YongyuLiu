...
a5 = ax5.plot(x, mammographic, '-', label='        ')
ax5.set_xlabel("(e)",size=15)
# ax5.set_ylabel("accurcy", size=15)
# ax5.legend(loc='upper left', fontsize=10)
ax52 = ax5.twinx()
a52 = ax52.plot(x, mammographic_time, '--r', label='      ')
